...
namespace TradingJournal.Infrastructure.Migrations
{
    ...
    [Migration("20260516122931_AddTradeImportFeature")]
    partial class AddTradeImportFeature
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TradingJournal.Domain.Entities.Mt5WebhookConfig", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.Property<string>("DefaultInstrumentMappings")
                        .HasColumnType("text");

                    b.Property<Guid?>("DefaultTradingAccountId")
                        .HasColumnType("uuid");
                    ...
                    b.Property<int>("TotalTradesImported")
                        .HasColumnType("integer");
                    ...
                    b.HasIndex("DefaultTradingAccountId");
            ...
            modelBuilder.Entity("TradingJournal.Domain.Entities.StrategyTemplate", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.Property<string>("SessionBadge")
                        .HasMaxLength(100)
                        .HasColumnType("character varying(100)");

                    b.Property<string>("TimeframeBadge")
                        .HasMaxLength(100)
                        .HasColumnType("character varying(100)");
            ...
            modelBuilder.Entity("TradingJournal.Domain.Entities.Trade", b =>
                {
                    ...
                    b.Property<long?>("Mt5TicketNumber")
            ...
            modelBuilder.Entity("TradingJournal.Domain.Entities.TradeImportLog", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.Property<string>("InsertedTradeIds")
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("TradingJournal.Domain.Entities.Mt5WebhookConfig", b =>
                {
                    b.HasOne("TradingJournal.Domain.Entities.TradingAccount", "DefaultTradingAccount")
                        .WithMany()
                        .HasForeignKey("DefaultTradingAccountId");
                    ...
                    b.Navigation("DefaultTradingAccount");
